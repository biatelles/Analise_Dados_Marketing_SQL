CREATE SCHEMA marketing AUTHORIZATION dsa;


-- Criação da tabela
CREATE TABLE marketing.campanha (
    id SERIAL,
...
CREATE OR REPLACE PROCEDURE marketing.inserir_dados_campanha()
LANGUAGE plpgsql
AS $$
DECLARE
    i INT := 1;
...
BEGIN
    LOOP
        ...
        -- Inserir registro
        INSERT INTO marketing.campanha 
...
-- Executa a SP
call marketing.inserir_dados_campanha();


-- Verifica os dados
SELECT * FROM marketing.campanha;